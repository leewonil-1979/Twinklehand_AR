...
class AppConstants {
  ...
  // UI 설정
  static const double iconGridHeight = 180.0; // 아이콘 그리드 높이 (더 크게)
  ...
  // 카메라 설정
  static const double aspectRatio = 9.0 / 16.0; // 세로 비율 (9:16)
  ...
  // 수익화 설정
  static const int freeUsageLimit = 10; // 무료 사용 제한 (10회)
