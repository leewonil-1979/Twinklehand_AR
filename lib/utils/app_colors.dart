...
class AppColors {
  ...
  static const Color dirtySecondary = Color(0xFF8D6E63); // 중간톤 갈색
  static const Color dirtyAccent = Color(0xFFBCAAA4); // 연갈색
  ...
  static const Color shadow = Color(0x1A000000); // 투명한 검정색
